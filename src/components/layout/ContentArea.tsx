...
import { BookOpen, CheckSquare, Plus, PanelLeftOpen } from "lucide-react";
      ...
      <div style={{ padding: "20px 32px 0", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
          ...
          <h2
            ...
            style={{ fontSize: "22px", fontWeight: 600, color: "#1A1A1A", margin: 0, flex: 1 }}
          >
              ...
              {showAddMenu && (
                ...
                >
                  <button
                    ...
                    style={{ width: "100%", display: "flex", alignItems: "center", gap: 10, padding: "12px 16px", background: "none", border: "none", cursor: "pointer", textAlign: "left", fontSize: "13px", color: "#1A1A1A", transition: "background 0.1s" }}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: "11px", color: "#9CA3AF", marginTop: 1 }}>Checkboxes · Auto-rollover</div>
                    </div>
                  </button>
                </motion.div>
              )}
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ fontSize: "13px", margin: 0, color: "#9CA3AF" }}>Create a Cornell note or task list to get started</p>
      </div>
      <div style={{ display: "flex", gap: 10 }}>
        <button
          onClick={() => { const id = addPage(dateKey, "cornell"); setActivePageId(id); }}
          style={{ padding: "10px 18px", borderRadius: 8, background: "#3D5A80", color: "white", border: "none", cursor: "pointer", fontSize: "13px", fontWeight: 500, display: "flex", alignItems: "center", gap: 6 }}
        >
          <BookOpen size={14} /> Cornell Notes
        </button>
        <button
          onClick={() => { const id = addPage(dateKey, "task"); setActivePageId(id); }}
          style={{ padding: "10px 18px", borderRadius: 8, background: "white", color: "#3D5A80", border: "1px solid #3D5A80", cursor: "pointer", fontSize: "13px", fontWeight: 500, display: "flex", alignItems: "center", gap: 6 }}
        >
